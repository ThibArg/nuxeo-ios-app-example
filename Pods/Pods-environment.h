...
// NuxeoSDK
#define COCOAPODS_POD_AVAILABLE_NuxeoSDK
#define COCOAPODS_VERSION_MAJOR_NuxeoSDK 0
#define COCOAPODS_VERSION_MINOR_NuxeoSDK 1
#define COCOAPODS_VERSION_PATCH_NuxeoSDK 1
